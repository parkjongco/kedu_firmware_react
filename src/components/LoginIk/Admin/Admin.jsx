...
const Admin = () => {
  ...
  useEffect(() => {
    axios.get('http://192.168.1.172/admin/departments', {
      headers: {
  ...
  useEffect(() => {
    if (form.department) {
      axios.get(`http://192.168.1.172/admin/departments/${form.department}/units`, {
        headers: {
          'Content-Type': 'application/json',
        }
      })
  ...
  useEffect(() => {
    axios.get('http://192.168.1.172/ranks', {
      headers: {
        'Content-Type': 'application/json',
      }
    })
  ...
  const handleUserSubmit = (e) => {
    ...
    axios.post('http://192.168.1.172/users', {
  ...
  const handleEmployeeSubmit = (e) => {
    ...
    axios.all([
      axios.get(`http://192.168.1.172/admin/departments/${form.department}`, {
        headers: {
          'Content-Type': 'application/json',
        }
      }),
      axios.get(`http://192.168.1.172/admin/units/${unitSeq}`, {
        headers: {
          'Content-Type': 'application/json',
        }
      }),
      axios.get(`http://192.168.1.172/ranks/${form.rank_seq}`, {
        headers: {
          'Content-Type': 'application/json',
        }
      })
    ...
    .then(axios.spread((departmentResponse, unitResponse, rankResponse) => {
      return axios.post('http://192.168.1.172/employees/register', {
        user_seq: userSeq,
        users_name: form.users_name,
